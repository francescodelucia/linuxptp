...
VER     = -DVER=$(version)
SIEMENS = -DSIEMENS_FIX_2
CFLAGS	= -Wall $(VER) $(incdefs) $(DEBUG) $(EXTRA_CFLAGS) $(SIEMENS)
...
OBJ	= bmc.o clock.o clockadj.o clockcheck.o config.o designated_fsm.o \
 ...
 unicast_fsm.o unicast_service.o util.o version.o threadpool/threadpool.o mod_webServer.o mod_udpServer.o mod_udpClient.o mod_memManager.o
